...
user_bp.route('/forgot', methods=['POST'])(forgotPassword)
user_bp.route('/forgot', methods=['GET'])(passwordChangeCodeCheck)
user_bp.route('/forgot', methods=['PATCH'])(changePasswordByCode)